...
// }
// let aA: A = new A(); // This is working as expected
// let b: B = new B(); // This is working too as child class use parents constructor
// let cC: B = new B();      // This is not working as child class must use parents constructor
// let d: B = new B();   // Thsi is also not working
...
// let bb: D = new D("",2); // This is not working because child class has its 2 argumnet constrcutor
